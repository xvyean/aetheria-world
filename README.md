...
| 维度 | 旧版（v4） | 重构版（v5） |
|---|---|---|
| 设定 | 七卷圣经，但纪年混乱（余光历/星辉历并存） | **设计宪法 + 九卷圣经**：`docs/DESIGN.md` 立规矩；纪年统一为 **星辉历**；新增《学院生活志》《世界舆图志》；十谜加厚（已知/异常/三说） |
